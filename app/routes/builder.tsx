...
export const meta: MetaFunction = () => [
  ...
  { property: 'og:title', content: `AI Website Builder | ${platformConfig.name}` },
  ...(absoluteUrl('/builder') ? [{ tagName: 'link', rel: 'canonical', href: absoluteUrl('/builder') }] : []),
      ...
      <div className="tp-page">
        <section className="tp-tool-heading">
          <div>
            ...
            <p>
              The website builder remains part of freebee.world while the public catalog stays focused on practical,
              browser-based tools.
            </p>
          </div>
        ...
        <section className="tp-workspace" aria-label="Website builder workspace">
          ...
          <p>Use freebee.world tools to prepare content, images, documents, and data for your site.</p>
